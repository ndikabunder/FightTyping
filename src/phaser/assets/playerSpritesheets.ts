export const playerSpritesheetFrame = {
  frameWidth: 768,
  frameHeight: 448
} as const;

export const playerSpritesheets = {
  idle: "/assets/images/player/Idle.png",
  dash: "/assets/images/player/Dash.png",
  skill: "/assets/images/player/skill.png",
  death: "/assets/images/player/death.png",
  victory: "/assets/images/player/victory.png",
